...
/* ✅ طبّق Cairo على span لكن استثنِ أيقونات Material (تصحيح selector) */
span:not(.material-icons):not(.material-symbols-outlined):not(.material-symbols-rounded):not(.material-symbols-sharp):not([class*="material-symbols"]):not(.mi){
    font-family: 'Cairo', sans-serif !important;
    direction: rtl !important;
    text-align: right !important;
}

/* ✅ أيقونات أصولي (Material Symbols) - RTL safe + ligatures forced */
.mi, .mi.material-symbols-rounded, .mi.material-symbols-outlined, .mi.material-symbols-sharp{
