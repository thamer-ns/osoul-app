...
# ==============================================================
# 🧠 Yahoo info cache (لتقليل 429 أثناء rerun)
# ==============================================================
_YAHOO_INFO_CACHE: Dict[str, Any] = {}
_YAHOO_INFO_CACHE_TS: Dict[str, float] = {}
_YAHOO_INFO_TTL_SEC = 60 * 60 * 24   # 24h
_YAHOO_INFO_COOLDOWN_SEC = 20        # cooldown after failures
...
def _fetch_yahoo_info(symbol: str) -> dict:
    """Fetch Yahoo `Ticker.info` with TTL cache + cooldown to reduce 429."""
