...
def apply_custom_css():
    st.markdown("""
        ...
        /* 2. إخفاء التلميحات الإنجليزية المزعجة (الحل الجذري) */
        ...
        /* 3. تنسيق القوائم المنسدلة (Expander) لتكون نظيفة */
        ...
        /* إخفاء أيقونة السهم الافتراضية واستبدالها (اختياري لتحسين الشكل) */
        div[data-testid="stExpander"] details summary svg {
            color: #0052CC !important;
        }

        /* 4. البطاقات الحيوية (KPI Cards) */
        .kpi-card {
