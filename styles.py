...
def apply_custom_css():
    st.markdown("""
        ...
        /* 2. === حل مشكلة الكلام الإنجليزي (Expand/Collapse) === */
        /* إخفاء أيقونة السهم (كما في كودك) لأنها مصدر التلميح */
        div[data-testid="stExpander"] details summary svg {
            display: none !important;
        }
        /* إخفاء أي عنصر تلميح (Tooltip) يظهر عند الماوس */
        div[role="tooltip"], 
        ...
        /* تحسين شكل العنوان في القائمة المنسدلة لتعويض اختفاء السهم */
        ...
        /* 3. === التصميم الحيوي (البطاقات المتفاعلة) === */
        .kpi-card {
        ...
        /* تأثير الحركة عند مرور الماوس (Hover) */
        .kpi-card:hover {
        ...
        /* 5. === تصميم الجداول (الرؤوس الزرقاء الفاتحة) === */
        .finance-table {
        ...
        .finance-table th {
            background-color: #F0F8FF !important; /* لونك المفضل */
