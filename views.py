...
# --- 1. الرئيسية (تمت إضافة الأيقونات) ---
def view_dashboard(fin):
    ...
    with c2: render_kpi("رأس المال المستثمر", safe_fmt(fin['total_deposited']-fin['total_withdrawn']), "neutral", "🏗️")
...
# --- 2. السجلات المالية (تمت إضافة الأيقونات) ---
def view_cash_log():
