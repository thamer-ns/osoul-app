...
def view_dashboard(fin):
    ...
    with c4: render_kpi("صافي الأرباح الكلية", f"{total_pl:,.2f}", total_pl) # اللون تلقائي
...
# === دوال الاستيراد الذكية (تم الحفاظ عليها بالكامل) ===
