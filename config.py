...
def get_master_styles(C):
    ...
    <style>
        ...
        .finance-table td {{ 
            ...
            color: {C['main_text']}; font-weight: 600;
        }}
        ...
        .kpi-title {{ font-size: 0.85rem; color: {C['sub_text']}; margin-bottom: 5px; }}
        .kpi-value {{ font-size: 1.3rem; font-weight: 800; color: {C['main_text']}; direction: ltr; display: inline-block; }}
        
        .section-header {{
            color: {C['primary']}; font-weight: 800; font-size: 1.1rem; 
