...
# --- بيانات الشركات السعودية (مصدر البيانات: تداول السعودية) ---
# تم تصنيف القطاعات بدقة حسب هيكلة السوق الرسمية
TADAWUL_DB = {
    # --- قطاع الطاقة ---
    ...
    '2230': {'name': 'الكيميائية', 'sector': 'الرعاية الصحية'}, # الشركة الكيميائية السعودية القابضة
    ...
    # --- قطاع تجزئة الأغذية والأدوية ---
    '4001': {'name': 'أسواق العثيم', 'sector': 'تجزئة الأغذية'},
    '4164': {'name': 'النهدي', 'sector': 'تجزئة الأغذية'}, # ملاحظة: النهدي يصنف أحياناً تجزئة وأحياناً أدوية، التصنيف الأدق تجزئة السلع الكمالية أو الأدوية
    ...
    '7204': {'name': 'توبي', 'sector': 'التقنية'}, # التطويرية الغذائية
    ...
    '4190': {'name': 'جرير', 'sector': 'السلع الكمالية'}, # تصنيفها الدقيق تجزئة سلع كمالية
    ...
    '6004': {'name': 'كاتريون', 'sector': 'الخدمات التجارية والمهنية'}, # التموين سابقاً
}
