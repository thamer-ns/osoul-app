...
def get_css(C):
    ...
    <style>
        ...
        /* === إصلاح أزرار القائمة (Navbar) === */
        div[data-testid="stHorizontalBlock"] button {{
            white-space: nowrap !important; /* يمنع نزول النص لسطر ثاني */
            overflow: hidden !important;
            text-overflow: ellipsis !important;
            padding: 0.3rem 0.5rem !important; /* تقليل الحواف الداخلية */
            font-size: 0.8rem !important; /* تصغير الخط ليتسع للجميع */
