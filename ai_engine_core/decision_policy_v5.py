...
V5.1 augments the raw report with the Python SC-V91 breakout engine *before*
the proven v4 qualification and geometry gates run. It then attaches provider
