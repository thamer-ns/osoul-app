...
SC-V90 correctly applies the asset-aware volume policy to most breakouts, but a
bearish break-and-role-reversal retest was emitted as confirmed even when a
trusted stock-volume feed explicitly failed the required participation test.
V91 keeps the pattern visible as FORMING while preventing it from entering the
confirmed signal/score path.
"""
