...
The V7 tables became authoritative for lifecycle reads.  Existing V6 events
must therefore be copied before the next T1/SL/C event is validated, otherwise
an active plan looks as though its initial NL/NS never existed.  This module
runs only for the authenticated tenant, preserves event identities and rebuilds
state from the newest V7 row after the copy.
"""
